...
public class JipiaoInternTasker extends QuartzLocalAppMaster {
	...
	private void checkflight(String flight_name, String flight, String DDate1)
			throws Exception {
		String[] s = flight
				.replace("http://flights.ctrip.com/international/Schedule/", "")
				.replace(".html", "").split("-");
		if (s == null || s.length != 2)
			return;
		createonetask(flight_name, s[0].toUpperCase(), s[1].toUpperCase(),
				DDate1);

	}

	public void createonetask(String flight_name, String DCity1, String ACity1,
			String DDate1) throws Exception {

		// get key from
		// http://flights.ctrip.com/international/abidjan-athens-abj-ath
		// condition =
		// '{"FlightWay":"S","SegmentList":[{"DCityCode":"ABJ","ACityCode":"ATH","DCity":"Abidjan
